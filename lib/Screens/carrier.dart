...
class carriertilewidget extends StatelessWidget {

  static const routeName = './carrier';
  ...
  Widget build(BuildContext context) {
    ...
    final list = scholarshipcategorylistdata.Carrierlist;



    return Scaffold(
      appBar: AppBar(title: Text("Carrier"),),
      body: Container(
